...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "vi": {
        ...
        "product_description_header": "💬 <b>Mô tả:</b>",
        ...
        "admin_market_wallet_balance": "🏪 Số dư ví chợ: <b>{amount}đ</b>",
    ...
    "en": {
        ...
        "admin_market_wallet_balance": "🏪 Market wallet balance: <b>{amount} VND</b>",
