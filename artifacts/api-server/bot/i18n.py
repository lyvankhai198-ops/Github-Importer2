...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "vi": {
        ...
        "product_sold_count": "🔥 Đã bán: {count}",
        "product_duration": "⌛ Thời hạn: {val}",
        "product_warranty": "🛡 Bảo hành: {val}",
        "product_info_header": "📋 <b>THÔNG TIN SẢN PHẨM</b>",
        "product_read_carefully_warning": "⚠️ <b>VUI LÒNG ĐỌC KỸ TRƯỚC KHI MUA</b>",
    ...
    "en": {
        ...
        "product_info_header": "📋 <b>PRODUCT INFORMATION</b>",
        "product_read_carefully_warning": "⚠️ <b>PLEASE READ CAREFULLY BEFORE BUYING</b>",
